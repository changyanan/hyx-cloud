...
/**
 * 
 * 根据36进制生产序列字符串（36进制包括大写字母和数字） 该序列合理使用理论上可以永远不重复
 * 
 * @author leige
 *
 */
public final class Sequence36 {
	private final static Logger LOGGER = LoggerFactory.getLogger(Sequence36.class);
	private final static TransforCode CODE_STRING = TransforCode36String.CODE_STRING;
	...
	private final static int SEQUENCE_SHIFT = 4;
