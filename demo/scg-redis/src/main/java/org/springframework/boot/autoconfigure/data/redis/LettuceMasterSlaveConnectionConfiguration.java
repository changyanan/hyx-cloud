...
public class LettuceMasterSlaveConnectionConfiguration extends RedisConnectionConfiguration {

	private final RedisProperties properties;

	private final List<LettuceClientConfigurationBuilderCustomizer> builderCustomizers;

	LettuceMasterSlaveConnectionConfiguration(RedisProperties properties,
	...
	private LettuceConnectionFactory createLettuceConnectionFactory(LettuceClientConfiguration clientConfiguration) {
		if (getSentinelConfig() != null) {
			return new LettuceMasterSlaveSentinelConnectionFactory(getSentinelConfig(), clientConfiguration);
		}
